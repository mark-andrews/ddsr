...
tibble(x = seq(0, 25),
  ...
  ggplot(aes(x = x, y = density, shape = lambda)) +
  geom_line() + 
  geom_point() +
  ylab('P(x)') + 
  scale_shape_discrete(name = TeX("$\\lambda"), labels = c("3.5", "5", "10", "15"))
```
...
p1 <- tibble(x = seq(0, 25),
  ...
  geom_point() +
  ylab('P(x)') +
  scale_shape_discrete(name = TeX("$\\lambda"), labels = c("3.5", "5", "7", "10", "average"))
